...
import com.app.cureace.activity.ambulance.MyAmbulanceBookingDetailsActivity;
...
public class AmbulanceBookingAdapter extends RecyclerView.Adapter<AmbulanceBookingAdapter.ViewHolder> {
    ...
    List<AmbulanceBookingModel> userList;
    Context context;

    public AmbulanceBookingAdapter(List<AmbulanceBookingModel> userList, Context context) {
    ...
    @NonNull
    @Override
    public AmbulanceBookingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AmbulanceBookingAdapter.ViewHolder holder, int position) {

        holder.appointmentid_tv.setText("ID :" + userList.get(position).getAmbulance_booking_id());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, MyAmbulanceBookingDetailsActivity.class);
    ...
    private void deleteAppointment(int position,ViewHolder viewHolder)
    {
        ...
        DatabaseReference mDatabaseRef = database.getReference()
                .child(AppUtil.AMBULANCE_BOOKING_TABLE_KEY)
